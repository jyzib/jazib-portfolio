                    ...
                    <div className={styles.cardGroup} ref={cardGroup}>
                        <div className={`${styles.card} ${styles.cardV1}`}>
                            <div className={styles.cardInner}>
                                <div className={styles.cardTitle}>Jazib Zaidi</div>
                                <div className={styles.cardDesc}>Frontend Developer</div>
                                <hr/>



                                <p>I am Jazib, a frontend developer with over a years of experience.
                                ...
                                <p>
                                    Frontend Developer | Yatharthriti it service pvt ltd <br/>
                                    React Developer Intern| Manindra Ashiyana Welfare Foundation <br/>
                                    Ui /UX Designer | LONDON BERRY
                                </p>
                            </div>
                            <figure className={styles.figure}>
                                <Image src="/jazib.png" alt="Jazib zaidi" width={150} height={150}/>
                            </figure>
                        </div>
